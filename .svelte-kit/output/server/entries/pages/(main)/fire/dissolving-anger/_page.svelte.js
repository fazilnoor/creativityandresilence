...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-1au42ha_START -->${$$result.title = `<title>Fire: Dissolving Anger</title>`, ""}<!-- HEAD_svelte-1au42ha_END -->`, ""}
<main class="content-page center" style="${"--grad-color: 25, 100%, 90%; --element-bg: linear-gradient(90deg, hsla(var(--grad-color),0),hsla(var(--grad-color),0.2) 10%, hsla(var(--grad-color),0.6) 20%,hsla(var(--grad-color),0.8) 50%, hsla(var(--grad-color),0.6) 90%, hsla(var(--grad-color),0) 100%) 0 /100% auto no-repeat, url(" + escape(base, true) + "/assets/fire/dissolving-anger-bg.webp) 0 35%/100% auto fixed repeat; --element-mob-bg: linear-gradient(hsla(var(--grad-color), .6), hsla(var(--grad-color), .6)), url(" + escape(base, true) + "/assets/fire/dissolving-anger-bg.webp) 50% 0/auto 100vh scroll repeat; --desc-bg-color: hsla(45, 50%, 75%, .9);--desc-copy-color: var(--light-color); --element-color: 25, 100%, 45%; --subtitle-color: 25, 100%, 50%; --cs1: 218, 45%, 33%; --cs2: 218, 45%, 75%"}"><section class="banner"><h2>Dissolving Anger <small>1:00</small></h2>
    <p class="subtitle shiftgrad"><span>How To Deal With Anger—A True Story</span></p>
    ${validate_component(JournalButton, "JournalButton").$$render($$result, Object.assign({}, jourButtonPos), {}, {})}</section>
  <section class="exercise"><p>Here Is A Method Of Dealing With Anger Given To A 9 Year Old Boy By A Renowned Buddhist Master, Thinley Norbu Rinpoche.</p>
    ...
    <h3>Three Steps to Dissolve Anger as Taught by Thinley Norbu Rinpoche
    </h3>
<ol><li>Take your mind off the object of your anger, whoever or whatever it may be.</li>
  ...
  <li>Whoever or whatever you are angry with is like a magnet. It will pull you back again and again. Resist this as much as possible. Come back to watching, again and again. As you do this practice you will begin to feel emotionally and mentally lighter and lighter.</li></ol>
<p>You can use this meditation technique with any passion, such as sorrow, irritation, fear, jealousy and so on.</p>

<hr>
<p class="continue-links light">Try the <a href="${escape(base, true) + "/fire/fire-meditation"}">Fire Meditation</a>, meet to the <a href="${escape(base, true) + "/fire/voice-of-fire"}">Voice of Fire</a>, try to <a href="${escape(base, true) + "/fire/stop-obsessive-thinking"}">Stop  Obsessive Thinking</a>
or explore more of the <a href="${escape(base, true) + "/fire"}">Fire Element</a>.
</p></section></main>
