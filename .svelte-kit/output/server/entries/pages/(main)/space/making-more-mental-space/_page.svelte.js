...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-17864us_START -->${$$result.title = `<title>Space: Making More Mental Space</title>`, ""}<!-- HEAD_svelte-17864us_END -->`, ""}
<main class="content-page center" style="${"--grad-color: 255, 75%, 90%; --element-bg: linear-gradient(90deg, hsla(var(--grad-color),0),hsla(var(--grad-color),0.5) 10%, hsla(var(--grad-color),0.7) 20%,hsla(var(--grad-color),0.9) 50%, hsla(var(--grad-color),0.7) 80%, hsla(var(--grad-color),.5) 90%, hsla(var(--grad-color),0) 100%) 0 0/100% auto no-repeat, url(" + escape(base, true) + "/assets/space/making-mental-space-bg.webp) 0 0/ cover fixed no-repeat; --element-mob-bg: linear-gradient(90deg, hsla(var(--grad-color), .9), hsla(var(--grad-color), .7)), url(" + escape(base, true) + "/assets/space/making-mental-space-bg.webp) 0 0/auto 100vh scroll repeat; --element-color: var(--dark-color); --subtitle-color: 255, 90%,33%; --cs2: 255, 50%, 75%; --cs1: 180, 100%, 33%;"}"><section class="banner"><h2>Making More Mental Space <small>3:14</small></h2>
    <p class="subtitle shiftgrad"><span>Clearing Space Is Finding Your Power Base</span></p></section>
  <section class="exercise">${validate_component(JournalButton, "JournalButton").$$render($$result, Object.assign({}, jourButtonPos), {}, {})}
    <div class="audio"><iframe width="100%" height="20" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/996577441%3Fsecret_token%3Ds-T182k3ZAoxc&color=%23ffff00&inverse=true&auto_play=false&show_user=true" title="Making More Mental Space"></iframe>
      <span class="runtime">3:14</span></div>
    ...
    <ol><li>Close your eyes and ask yourself, What is the main thing bothering me now? Write this on a piece of paper and move it to one side.</li>
      ...
      <li>Keep the papers until all the written concerns are resolved.</li></ol>

    <p>You are learning how to manage your concerns one-by-one without becoming overwhelmed.</p>
<hr>
    <p class="continue-links light">Continue exploring with <a href="${escape(base, true) + "/space/space-meditation"}">Space Mediation</a> or <a href="${escape(base, true) + "/space/present-moment-meditation"}">Present Moment Meditation</a>, meet the <a href="${escape(base, true) + "/space/voice-of-space"}">Voice of Space</a> or explore more of the <a href="${escape(base, true) + "/space"}">Space Element</a>.</p></section>
  <section class="creator-bio"><h3>About the Instructor</h3>
      <p>Dr. Scales is an author and photographer. Her works include <em>Sacred Voices of the Nyingma Masters</em> and <em>Sacred Words Spoken</em>. She holds a Ph.D. in East-West Psychology and consults privately.</p></section></main>
