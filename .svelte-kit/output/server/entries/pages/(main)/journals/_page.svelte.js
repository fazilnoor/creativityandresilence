...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-1hfidxv_START -->${$$result.title = `<title>Creative Resilience: Explore Your Experience</title>`, ""}<!-- HEAD_svelte-1hfidxv_END -->`, ""}
<main class="content-page center journals" style="--element-bg: hsl(var(--dark-color)); --element-mob-bg: hsl(var(--dark-color)); --copy-color: var(--light-color); --element-color: var(--copy-color);"><section class="introduction"><h2 style="--h2-font-size: var(--h4-font-size);">Explore Your Experience</h2>
